...
describe('next-sitemap/config', () => {
    test('defaultConfig', () => {
        expect(_1.defaultConfig).toStrictEqual({
            sourceDir: '.next',
            outDir: 'public',
    ...
    test('withDefaultConfig', () => {
        const myConfig = (0, _1.withDefaultConfig)({
    ...
    test('withDefaultConfig: default transformation', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Default transform
        yield expect(myConfig.transform(myConfig, 'https://example.com')).resolves.toStrictEqual({
        ...
        yield expect(myConfig.transform(Object.assign(Object.assign({}, myConfig), { trailingSlash: true }), 'https://example.com')).resolves.toStrictEqual({
            loc: 'https://example.com',
            lastmod: expect.any(String),
            changefreq: 'weekly',
            priority: 0.6,
