...
export const loadConfig = (path) => __awaiter(void 0, void 0, void 0, function* () {
    const baseConfig = yield loadFile(path);
...
export const getRuntimeConfig = (runtimePaths) => __awaiter(void 0, void 0, void 0, function* () {
    const exportMarkerConfig = yield loadFile(runtimePaths.EXPORT_MARKER, false).catch((err) => {
...
export const updateWithRuntimeConfig = (config, runtimePaths) => __awaiter(void 0, void 0, void 0, function* () {
    // Runtime configs
